...
<div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
        <div class="col-lg-6 px-0">
            ...
            <p class="lead mb-0">
                <a href="{{ url('news?category_id='.$latest['category_id'].'&id='.$latest['id']) }}" class="text-body-emphasis fw-bold">
                    {{ trans('main.readmore') }}
                </a>
            </p>
        </div>
            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <a href="{{ url('news?category_id='.$news1['cat_id'].'&id='.$news1['id']) }}" class="icon-link gap-1 icon-link-hover stretched-link">
                            {{ trans('main.readmore') }}
                            <svg class="bi">
                        ...
                        <?php while ($news = mysqli_fetch_assoc($latest_news['query'])): ?>
                            ...
                            <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                               href="{{ url('news?category_id='.$news['category_id'].'&id='.$news['id']) }}">
                                ...
                                ?>
                                <img src="{{ $img }}" class="bd-placeholder-img" style="width: 100px; height: 96px;">
                                <div class="col-lg-8">

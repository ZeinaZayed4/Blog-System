...
<div class="container">
        ...
        <div class="row flex-nowrap justify-content-between align-items-center">
            <div class="col-4 pt-1">
                <?php if (session('locale') == 'ar') : ?>
                    <a class="link-secondary" href="<?=url('lang?lang=en')?>"><?=trans('main.english')?></a>
                <?php else: ?>
                    <a class="link-secondary" href="<?=url('lang?lang=ar')?>"><?=trans('main.arabic')?></a>
                <?php endif; ?>
            </div>
    ...
    <div class="nav-scroller py-1 mb-3 border-bottom">
        <nav class="nav nav-underline justify-content-between">
            <a class="nav-item nav-link link-body-emphasis <?php echo  empty(request('category_id')) ? 'active' : '' ; ?>" href="<?php echo  url('/') ; ?>"><?php echo  trans('main.home') ; ?></a>
            <?php

...
<div class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary">
        <div class="col-lg-6 px-0">
            ...
            <p class="lead mb-0">
                <a href="<?php echo  url('news?category_id='.$latest['category_id'].'&id='.$latest['id']) ; ?>" class="text-body-emphasis fw-bold">
    ...
    <?php
        $news1 = db_first('news', 'JOIN categories on news.category_id = categories.id
            ORDER BY news.id DESC', 'categories.name as cat_name, categories.id as cat_id, news.title, news.id, news.description, news.created_at, news.image');
        $news2 = db_first('news', 'JOIN categories on news.category_id = categories.id WHERE news.category_id !=  "' . $news1['cat_id'] . '"
            ORDER BY news.id DESC', 'categories.name as cat_name, categories.id as cat_id, news.title, news.id, news.description, news.created_at, news.image');
    ?>
    <div class="row mb-2">
        <?php if (!empty($news1)) : ?>
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <a href="<?php echo  url('news?category_id='.$news1['cat_id'].'&id='.$news1['id']) ; ?>" class="icon-link gap-1 icon-link-hover stretched-link">
                            <?php echo  trans('main.readmore') ; ?>
                            <svg class="bi">
    ...
    <div class="row g-5">
        ...
        <div class="col-md-4">
            <div class="position-sticky" style="top: 2rem;">
                ...
                <?php $latest_news = db_get('news', 'ORDER BY id DESC LIMIT 10') ?>
                <div>
                        ...
                        <?php while ($news = mysqli_fetch_assoc($latest_news['query'])): ?>
                            ...
                            <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                               href="<?php echo  url('news?category_id='.$news['category_id'].'&id='.$news['id']) ; ?>">
                                ...
                                ?>
                                <img src="<?php echo  $img ; ?>" class="bd-placeholder-img" style="width: 100px; height: 96px;">
                                <div class="col-lg-8">

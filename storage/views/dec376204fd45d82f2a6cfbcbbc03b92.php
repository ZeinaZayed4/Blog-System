<?php
    ...
    $comment = db_first('comments', "JOIN news on comments.news_id = news.id WHERE comments.id = " . (int)request('id'),
        "news.title as title, comments.id, comments.name, comments.email, comments.status, comments.comment, comments.news_id");
...
?>
        ...
        <form method="post" action="<?php echo  aurl('comments/edit?id='.$comment['id']) ; ?>" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="news_id"> <?php echo  trans('comment.news') ; ?></label>
                        <a name="news_id" href="<?php echo  aurl('news/show?id='.$comment['news_id']) ; ?>" target="_blank"><?php echo  $comment['title'] ; ?></a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea name="comment" placeholder="<?php echo  trans('comment.comment') ; ?>" class="form-control <?= !empty($comment) ? 'is-invalid' : '' ?>">
